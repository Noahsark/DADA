...
class Network(torch.nn.Module):
    def __init__(self, opt):
        ...
        # to solve the CERTIFICATE_VERIFY_FAILED problem. but its not secured
        ...
        if 'layernorm' in self.pars.arch:
            self.lnorm = nn.LayerNorm(opt.embed_dim, elementwise_affine=False).cuda()
